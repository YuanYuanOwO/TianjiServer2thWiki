...
---
# 优化说明
这里记载了天际服的生存服服务端文件（bukkit.yml spigot.yml等），可以根据下方文件来优化您的红石机器或者刷怪塔。  
服务端版本号:`Paper-1.20.1-126`  
参考资料：[Paperchan优化指南](https://paper-chan.moe/paper-optimization/)，[PaperMC官方文档](https://docs.papermc.io/paper)  
# server.properties
```yaml
#Minecraft server properties
#Wed Jun 28 17:54:57 CST 2023
