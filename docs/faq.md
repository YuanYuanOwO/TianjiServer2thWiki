...
输入 `/ping` 指令检查您到服务器的延迟，如果显示异常可能是您的网络与服务器连接不畅，在联系管理组反馈延迟异常之前，您可以尝试以下服务器地址
...
* 会在服务器更新游戏版本时进行重置更新，请不要建造家园以及大型工程，后果自负
...
在周目后期或者其它特殊时期，服务器会因为原版玩法的不足或其它状况而进入日活降低的状态，您可以邀请自己的小伙伴或者通过以下几个渠道来帮助服务器进行宣传。
...
对 [天际服宣传贴](https://www.minebbs.com/threads/34421/) 使用道具
`紫晶顶贴卡`有助于宣传贴的流量上涨  
